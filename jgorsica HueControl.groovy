	...
	section("Choose light effects...")
		{
			...
			input "restoreLevels", "enum", title: "Restore Levels after timeout?", required: true, multiple:false, options: ["Yes","No"]
...
private takeAction(evt) {
	...
	def newValue = [hue: hueColor, saturation: 70, level: (lightLevel as Integer) ?: 100]
